...
function AccountCategory() {
    ...
    const loadAccountCategoryData = async () => {
        try {
          const response = await axios.get(`${import.meta.env.VITE_API_URL}/account-category`);
    ...
    const handleDelete = async (id) => {
        ...
        try {
          const response = await axios.delete(`${import.meta.env.VITE_API_URL}/account-category/delete/${id}`);
