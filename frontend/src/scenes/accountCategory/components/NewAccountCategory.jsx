...
export default function NewAccountCategory({ onAccountCategoryAdded, onClosePopup }) {
    ...
    useEffect(() => {
      if (id) {
          axios.get(`${import.meta.env.VITE_API_URL}/account-category/read/${id}`)
          .then((res) => {
...
const handleSubmit = async (e) => {
  e.preventDefault();
  const apiURL = id ? `${import.meta.env.VITE_API_URL}/account-category/edit/${id}` : `${import.meta.env.VITE_API_URL}/account-category/new`
