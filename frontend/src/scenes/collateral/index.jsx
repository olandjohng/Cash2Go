...
function Collateral() {
    ...
    const loadCollateralData = async () => {
        try {
          const response = await axios.get(`${import.meta.env.VITE_API_URL}/collateral`);
      ...
      const handleDelete = async (id) => {
        ...
        try {
          const response = await axios.delete(`${import.meta.env.VITE_API_URL}/collateral/delete/${id}`);
