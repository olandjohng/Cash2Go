...
const INITIAL_FORM_STATE = {
  ...
  const FORM_VALIDATION = Yup.object().shape({
    deductionType: Yup.string().required("Required"),
  });

export default function DeductionForm({ onDeductionAdded, onClosePopup }) {
      ...
      {(formikProps) => (
        <Form>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Textfield name="deductionType" label="Deduction Name" />
            </Grid>
          </Grid>
