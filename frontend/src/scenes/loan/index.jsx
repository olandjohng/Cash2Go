...
export default function Loan() {
  ...
  const [restructureFormValue, setRestructureFormValue] =
    useState(LOAN_INITIAL_VALUES);
  ...
  const handleEditLoan = async (id) => {
    try {
      ...
      setEditFormValue(formattedData);
  ...
  return (
    <Box height="100%" padding={2} display="flex" flexDirection="column">
      ...
      >
        <LoanRestructureForm
          dispatcher={dispatch}
          popup={setOpenRestructurePopup}
          loanInitialValue={restructureFormValue}
          accountTitle={accountTitle}
          banks={banks}
          collaterals={collaterals}
          categories={categories}
      ...
      >
        <Amortization
          banks={banks}
          headerId={amortizationId.current}
          success={() => setOpenAmortizationPopup(false)}
        />
      </Popups>
      ...
      <Popups
        title="Edit Loan"
        openPopup={openEditLoanPopup}
        setOpenPopup={setOpenEditLoanPopup}
      >
        <LoanForm1
          loanInitialValue={editFormValue}
          setModalOpen={setOpenEditLoanPopup}
          collaterals={collaterals}
          facilities={facilities}
          banks={banks}
          categories={categories}
